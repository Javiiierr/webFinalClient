...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`https://web-final-server.vercel.app`, { // makes a POST request to http://localhost:8080/login to server/Controllers/AuthControllers login function
