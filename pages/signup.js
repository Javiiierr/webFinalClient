...
export default function SignUp() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`https://web-final-server.vercel.app/register`, { // makes a POST request to http://localhost:8080/register to server/Controllers/AuthControllers register
